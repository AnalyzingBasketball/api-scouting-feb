    ...
    def gen_filas(lineups_data):
        ...
        for l in lineups_data:
            ...
            for p in l['jugadores']:
                ...
                jugadores_ord.append(f"<div class='player-card'><div style='color:#2b6cb0;font-size:10px;font-weight:900;margin-bottom:4px;text-transform:uppercase;'>{role}</div><img src='{f_url}'><br>{n_corto}</div>")
